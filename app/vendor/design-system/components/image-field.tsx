...
interface ImageFieldProps
  extends ImageFieldOwnProps, ImageFieldContainerProps, MarginProps {}

const ImageFieldRoot = React.forwardRef<HTMLDivElement, ImageFieldProps>(
  (props, forwardedRef) => {
    const {
      id,
      name,
...
interface ImageFieldPreviewProps extends Omit<
  React.ComponentPropsWithoutRef<'div'>,
  'children'
> {
...
const ImageFieldPreview = React.forwardRef<
  HTMLDivElement,
