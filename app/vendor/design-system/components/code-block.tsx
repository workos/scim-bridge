...
const CodeBlockRoot = React.forwardRef<HTMLDivElement, CodeBlockRootProps>(
  (props, forwardedRef) => {
    ...
    return (
      <div
        ref={forwardedRef}
        className={classNames('CodeBlockRoot', className)}
        {...rootProps}
      />
    );
  },
...
const CodeBlockOutput = React.forwardRef<
  HTMLOutputElement,
  React.ComponentPropsWithRef<'output'>
>(({ className, children, ...props }, forwardedRef) => (
  <output
    ref={forwardedRef}
    className={classNames('CodeBlockOutput', className)}
    {...props}
  >
    <ScrollArea.Root>
...
>(({ className, ...props }, forwardedRef) => (
  <div
    ref={forwardedRef}
    className={classNames('CodeBlockHeader', className)}
    {...props}
  />
));
...
>(({ className, ...props }, forwardedRef) => (
  <div
    ref={forwardedRef}
    className={classNames('CodeBlockFooter', className)}
    {...props}
  />
));
...
>(
  (
    { className, children, wrap, height, maxHeight, ...props },
    forwardedRef,
  ) => (
    <pre
      ref={forwardedRef}
...
interface CodeBlockLineGroupProps
  extends
    ...
    CodeBlockLineGroupOwnProps {}

const CodeBlockLineGroup = React.forwardRef<
  HTMLTableElement,
  CodeBlockLineGroupProps
...
interface CodeBlockLineProps
  extends
    Omit<React.ComponentPropsWithRef<'tr'>, 'color'>,
    CodeBlockLineOwnProps {}
