...
>((props, forwardedRef) => {
  ...
  const { className, children, color, container, forceMount, ...contentProps } =
...
>;
type DropdownMenuRadioItemOwnProps = GetPropDefTypes<
  typeof dropdownMenuRadioItemPropDefs
>;
