...
import { type ThemeContextValue, Theme, useThemeContext } from './theme.js';
import { themePropDefs } from './theme.props.js';
import { Tooltip } from './tooltip.js';

interface ThemePanelProps extends Omit<
  ThemePanelImplProps,
  keyof ThemePanelImplPrivateProps
> {
...
const ThemePanelImpl = React.forwardRef<
  ...
  ThemePanelImplProps
>((props, forwardedRef) => {
  const { open, onAppearanceChange, shortcut, triggerRef, ...panelProps } =
    props;
...
const ThemePanelContent = React.forwardRef<
  ThemePanelContentElement,
  ...
  return (
    <Flex direction="column" gap="5" {...contentProps} ref={forwardedRef}>
      ...
      <Flex direction="column" gap="5">
        {/* Accent color */}
        <ThemePanelSection>
          <ThemePanelHeading id="accent-color-title">
            Accent color
          </ThemePanelHeading>
          <Flex
            wrap="wrap"
                  ...
                  >
                    <input
                      ...
                      onChange={(event) =>
                        onAccentColorChange(
                          // eslint-disable-next-line @typescript-eslint/consistent-type-assertions
                          event.target.value as typeof accentColor,
                        )
                      }
                    />
                  </Tooltip>
        ...
        {/* Gray color */}
        <ThemePanelSection>
          <ThemePanelHeading id="gray-color-title">
            Gray color
          </ThemePanelHeading>
          <Flex
            wrap="wrap"
                  ...
                  >
                    <input
                      ...
                      onChange={(event) =>
                        onGrayColorChange(
                          // eslint-disable-next-line @typescript-eslint/consistent-type-assertions
                          event.target.value as typeof grayColor,
                        )
                      }
                    />
                  </Tooltip>
        ...
        {/* Appearance */}
        <ThemePanelSection>
          <ThemePanelHeading id="appearance-title">
            Appearance
          </ThemePanelHeading>
          <Grid
            columns="2"
              ...
              <Flex key={value} direction="column" align="center">
                <label className="rt-ThemePanelRadioCard">
                  <input
                    ...
                    onChange={(event) =>
                      // eslint-disable-next-line @typescript-eslint/consistent-type-assertions
                      onRadiusChange(event.target.value as typeof radius)
                    }
                  />
        ...
        <ThemePanelSection>
          <Flex align="center" gap="2">
            <ThemePanelHeading id="panel-background-title">
              Panel background
            </ThemePanelHeading>
            <Popover.Root>
              <Popover.Trigger>
              ...
              >
                <Text as="p" size="1">
                  Whether Card and Table panels are translucent, showing some of
...
export type { ThemePanelContentProps, ThemePanelProps };
